...
SUBEXPR                     -> equal CONDOREXPR SUBEXPR 
                             | e .
...
SUBEQUALITYEXPR             -> equality RELATIONALEXPR SUBEQUALITYEXPR
                             | notequality RELATIONALEXPR SUBEQUALITYEXPR
                             | e .

RELATIONALEXPR              -> ADDITIVEEXPR SUBRELATIONALEXPR .
SUBRELATIONALEXPR           -> less ADDITIVEEXPR SUBRELATIONALEXPR
                             | lesser ADDITIVEEXPR SUBRELATIONALEXPR
                             | great ADDITIVEEXPR SUBRELATIONALEXPR
                             | greater ADDITIVEEXPR SUBRELATIONALEXPR
                             | e .

ADDITIVEEXPR                -> MULTIPLICATIVEEXPR SUBADDITIVEEXPR.
SUBADDITIVEEXPR             -> plus MULTIPLICATIVEEXPR SUBADDITIVEEXPR
                             | minus MULTIPLICATIVEEXPR SUBADDITIVEEXPR 
                             | e .

MULTIPLICATIVEEXPR          -> UNARYEXPR SUBMULTIPLICATIVEEXPR .
SUBMULTIPLICATIVEEXPR       -> mul UNARYEXPR SUBMULTIPLICATIVEEXPR
                             | div UNARYEXPR SUBMULTIPLICATIVEEXPR 
                             | e .
...
PROPERARGLIST               -> EXPR SUBPROPERARGLIST
                             | e .
SUBPROPERARGLIST            -> comma EXPR SUBPROPERARGLIST
                             | e .
```